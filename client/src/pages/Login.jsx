...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* Left: brand panel with the building illustration */}
      <div className="hidden lg:flex flex-col justify-between bg-ink bg-blueprint bg-grid p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-display text-4xl font-semibold leading-tight mb-4">
            Every request,<br />tracked in real time.
          </h1>
          <p className="text-slate-200 max-w-sm">
            Maintenance tickets, amenity bookings, and property status —
            all synced live across every tenant and owner.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-paper">
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <p className="text-sm text-slate-500 mt-5 text-center">
            No account?{" "}
            <Link to="/register" className="text-blueprint font-medium hover:underline">
              Register
            </Link>
          </p>
        </form>
